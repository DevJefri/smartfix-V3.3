...
/** Manejo centralizado de errores del microservicio de cotizacion. */
@RestControllerAdvice
public class GlobalExceptionHandler {

    @ExceptionHandler(CotizacionInvalidaException.class)
    public ResponseEntity<Map<String, Object>> handleCotizacionInvalida(CotizacionInvalidaException ex) {
